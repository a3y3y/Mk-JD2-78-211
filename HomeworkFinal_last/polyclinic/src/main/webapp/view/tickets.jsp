...
<div class="col-md-3">
    <button class="btn btn-primary" name="delete-tickets" id="delete-tickets">Удалить талоны</button>
</div>
<div class="col-md-3">
    <button class="btn btn-primary" type="submit" name="post" id="post" form="form">Добавить талоны</button>
</div>
