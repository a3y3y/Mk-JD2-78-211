...
@Configuration
@EnableJpaRepositories("by.it_academy.jd2.hw.example.messenger.storage")
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("by.it_academy.jd2.hw.example.messenger.model");
        ...
        properties.setProperty("hibernate.default_schema", "mess");
